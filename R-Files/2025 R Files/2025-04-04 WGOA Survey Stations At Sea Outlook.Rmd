...
with the DAS we have left.  Variables that can be adjusted:  Depart Time (line 95), Ship Speed = 10 (line 97).  Lastly, station order matters in terms of distance (line 60), so adjust if neccessary.  
...
# Completed Stations
CompleteScenL <- length(c(1:26)) #Fill in with completed StaTDL stations
...
DH_SIP <- ymd_hm("2023-05-17 10:00") 
