...
# Completed Stations
CompleteScenL <- length(c(1:101)) #Fill in with completed StaTDL stations
...
depart <- lubridate::now(tzone = "America/Anchorage") + dhours(1) # Alaska time, for at sea calculations
