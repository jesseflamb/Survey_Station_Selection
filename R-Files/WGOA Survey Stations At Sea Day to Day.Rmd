...
---
Day to Day: The purpose of this markdown is to determine the next Days sampling. Variables that can be adjusted: Gear.Sampled per station and time taken to sample gear (lines 82-85), Ship Speed (line 92).  Lastly, station order matters in terms of distance (line 56).  
...
## Completed Stations
CompleteScenL <- length(c(1:156)) #Fill in with completed StaTDL stations
