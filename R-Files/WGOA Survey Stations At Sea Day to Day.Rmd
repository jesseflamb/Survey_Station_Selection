...
---
Day to Day: The purpose of this markdown is to determine the next Days sampling. Variables that can be adjusted: Gear.Sampled per station and time taken to sample gear (lines 77-80), Ship Speed (line 83).  Lastly, station order matters in terms of distance (line 52).  
...
## Completed Stations
CompleteScenL <- length(c(1,6,5,2:4,7:9)) #Fill in with completed StaTDL stations

## Stations Remaining
StaTDL<-c(24:28,59:53)
...
depart <- lubridate::now(tzone = "America/Anchorage") + dhours(5.5)
