...
with the DAS we have left.  Variables that can be adjusted:  Depart Time (line 95), Ship Speed (line 106).  Lastly, station order matters in terms of distance (line 60), so adjust if neccessary.  
...
# Completed Stations
CompleteScenL <- length(c(1:6,7:9)) #Fill in with completed StaTDL stations

# Staions Remaining 
StaTDL<-c(24:28,59:53,84:77,92:85,100:93,107:101,113:108,119:114, 
          125:120,131:126,136:132,141:137,147:142,152:148, 156:153, 
          159:157,165:160,166:179,180,213:208,216,218,220,228:225,234:238,271) 
...
depart <- lubridate::now(tzone = "America/Anchorage") + dhours(8) # Alaska time, for at sea calculations
