...
with the DAS we have left.  Variables that can be adjusted: Gear.Sampled per station and time taken to sample gear (lines 82-85), Ship Speed (line 92).  Lastly, station order matters in terms of distance (line 56).  
